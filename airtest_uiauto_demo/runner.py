    ...
    def run_air(self, root_dir='', device=[]):
        ...
        for f in os.listdir(root_dir):
            if f.endswith(".air"):
                ...
                #logss=os.path.join('..\\'+'log' + '\\' + airName.replace('.air', ''))
                print(log)
        ...
        env = jinja2.Environment(
            ...
            #os.path.dirname(os.path.abspath(__file__))返回当前文件所在的目录
            extensions=(),
            autoescape=True
        )
...
if __name__ == '__main__':
    ...
    #vivo s1:EMWOAYJNFMGUFU89
    device = ['android:///EMWOAYJNFMGUFU89']
    test.run_air(root_path, device)
    #将生成的报告打包：
    #zip_file_path(r".\air_case", 'D:', 'multireport.zip')
    # #将报告发送至邮箱：
    # emailaddr="wb-wgz629946@alibaba-inc.com"
    # sendmail(emailaddr)
